...
public class MockTaskRunFactory {
    public static TaskRun generateSampleTaskRun(Long id, Task task, Clock mockClock) {
    ...
    public static TaskAttempt generateTaskAttempt(Long id, TaskRun taskRun, int attempt, Clock mockClock) {
