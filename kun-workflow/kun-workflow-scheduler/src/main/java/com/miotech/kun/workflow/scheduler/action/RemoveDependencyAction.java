...
public class RemoveDependencyAction implements TaskRunAction {

    private final TaskManager taskManager;

    public RemoveDependencyAction(TaskManager taskManager) {
    ...
    public void run(TaskRunSMMessage message) {
        ...
        taskManager.removeDependency(taskAttempt,event.getFromTaskRunContext());
    }
