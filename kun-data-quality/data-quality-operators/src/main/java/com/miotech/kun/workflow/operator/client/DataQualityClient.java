...
public class DataQualityClient {
    ...
    private static final String EXPECTATION_METRICS_TABLE_NAME = "kun_dq_metrics";
    ...
    private static final List<String> EXPECTATION_METRICS_COLUMNS = ImmutableList.of("metrics_id", "execution_result", "collected_at");
    ...
    public void recordMetricsCollectedResult(Long expectationId, MetricsCollectedResult metricsCollectedResult) {
        String insertSql = DefaultSQLBuilder.newBuilder()
                .insert(EXPECTATION_METRICS_COLUMNS.toArray(new String[0]))
                .into(EXPECTATION_METRICS_TABLE_NAME)
                .asPrepared()
                .getSQL();
        databaseOperator.create(insertSql, expectationId,
                JSONUtils.toJsonString(metricsCollectedResult.getResult()), metricsCollectedResult.getCollectedAt());
    }
