...
public class DataQualityControllerTest extends DataQualityTestBase {
    ...
    public void testGetByDatasetGid() throws Exception {
        ...
        String findByIdUrl = "/kun/api/v1/data-qualities";
        ...
        String content = JSONUtils.toJsonString(expectationsRequest);
        MvcResult mvcResult = mvc.perform(MockMvcRequestBuilders.get(findByIdUrl)
                .content(content)
