...
public class AssertionRequest {
    ...
    public Assertion convertTo() {
        ...
        switch (comparisonOperator) {
            ...
            case ABSOLUTE:
                return new AbsoluteAssertion(null, this.expectedValue, ComparisonPeriod.forValue(comparisonPeriod));
            case RISE:
                return new RiseAssertion(null, this.expectedValue, ComparisonPeriod.forValue(comparisonPeriod));
            case FALL:
                return new FallAssertion(null, this.expectedValue, ComparisonPeriod.forValue(comparisonPeriod));
            default:
    ...
    public static AssertionRequest convertFrom(Assertion assertion) {
        ...
        if (assertion instanceof VolatilityAssertion) {
            ...
            assertionRequest.setComparisonPeriod(volatilityAssertion.getComparisonPeriod().name());
        }
