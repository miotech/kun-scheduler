 ...
 **/
public class ConnectionInfoBasicInfoConvertFactory implements ConverterFactory<ConnectionBasicInfoVo, ConnectionInfoVO> {

    @Override
    public <T extends ConnectionInfoVO> Converter<ConnectionBasicInfoVo, T> getConverter(Class<T> targetType) {
        return source -> {
