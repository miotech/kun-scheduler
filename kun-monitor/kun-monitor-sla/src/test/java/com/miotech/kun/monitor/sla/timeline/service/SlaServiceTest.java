...
public class SlaServiceTest extends AppTestBase {
    ...
    public void testSave_withoutNullProperties() {
        ...
        assertThat(node.getRunTime(), is(taskDefinitionNode.getRunTime()));
    ...
    public void testUpdateRunTime() {
        ...
        slaService.save(taskDefinitionNode);
        // update runTime
        taskDefinitionNode.setRunTime(taskDefinitionNode.getRunTime() + 1);
        slaService.updateRunTime(taskDefinitionNode.getId(), taskDefinitionNode.getRunTime());
        // validate
        TaskDefinitionNode node = slaService.findById(taskDefinitionNode.getId());
        assertThat(node, notNullValue());
