...
import { SuggestionRelationContext } from "./SparkSqlParser";
...
export interface SparkSqlListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by `SparkSqlParser.suggestionRelation`.
	 * @param ctx the parse tree
	 */
	enterSuggestionRelation?: (ctx: SuggestionRelationContext) => void;
	/**
	 * Exit a parse tree produced by `SparkSqlParser.suggestionRelation`.
	 * @param ctx the parse tree
	 */
	exitSuggestionRelation?: (ctx: SuggestionRelationContext) => void;
