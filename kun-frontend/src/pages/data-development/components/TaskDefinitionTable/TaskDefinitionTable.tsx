...
export const TaskDefinitionTable: React.FC<Props> = memo(
  function TaskDefinitionTable(props) {
    const {
      taskDefViewId,
      filters,
      updateTime,
      ...
      () => [
        {
          ...
          render: (txt, record) => (
            <Link
              to={SafeUrlAssembler(
                `/data-development/task-definition/:taskDefId`,
              )
                .param({
                  taskDefId: record.id,
                })
        ...
        },
        {
          ...
          render: (txt: any, record: TaskDefinition) => (
            <UsernameText userId={record.owner} />
          ),
        },
        {
          key: 'createTime',
        ...
        },
        {
          ...
          render: (txt: any, record: TaskDefinition) =>
            record.createTime != null
              ? dayjs(record.lastUpdateTime).format('YYYY-MM-DD HH:mm:ss')
              : '-',
        },
        {
          key: 'isDeployed',
    ...
    const handleTableChange: TableOnChangeCallback<TaskDefinition> = useCallback(
      pagination => {
    ...
    return (
      ...
      >
        <header
          className={styles.TaskDefTableHeading}
          data-tid="task-definition-table-heading"
        >
          <Space>
            <span
              className={styles.SelectedItemsCountText}
              data-tid="selected-items-count"
            >
