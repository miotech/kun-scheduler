...
public final class SecurityGrpc {
  ...
  private static final int METHODID_FIND_ROLE_ON_SPECIFIED_MODULE = 0;
  private static final int METHODID_FIND_ROLE_ON_SPECIFIED_RESOURCES = 1;
  private static final int METHODID_ADD_SCOPE_ON_SPECIFIED_ROLE = 2;
  private static final int METHODID_DELETE_SCOPE_ON_SPECIFIED_ROLE = 3;
