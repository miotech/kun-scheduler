...
import com.miotech.kun.workflow.core.model.lineage.AthenaDataStore;
...
public class GlueTableExtractor extends ExtractorTemplate {
    ...
    protected DatasetFieldStat getFieldStats(DatasetField datasetField) {
        QueryEngineStatService statService = new QueryEngineStatService(table.getDatabaseName(), table.getName(),
    ...
    protected DataStore getDataStore() {
        return new AthenaDataStore(QueryEngine.parseConnInfos(dataSource.getQueryEngine())[0], table.getDatabaseName(), table.getName());
    }
