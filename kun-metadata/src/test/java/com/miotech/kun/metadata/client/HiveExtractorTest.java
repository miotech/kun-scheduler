...
import com.miotech.kun.metadata.load.PrintLoader;
...
public class HiveExtractorTest {
    ...
    public void testExtractor() {
        ...
        builder.withDataStoreUrl("jdbc:hive2://10.0.0.85:10000").withDataStoreUsername(null).withDataStorePassword(null)
