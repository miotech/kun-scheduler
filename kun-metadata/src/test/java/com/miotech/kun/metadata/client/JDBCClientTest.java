...
//            assertThat(databases, containsInAnyOrder("default", "dm", "dw", "sys"));
    ...
    public void testTableStat_athena() {
        ...
        ResultSet resultSet = null;
        try {
            connection = JDBCClient.getConnection(DatabaseType.ATHENA, "jdbc:awsathena://athena.ap-northeast-1.amazonaws.com:443;S3OutputLocation=s3://com.miotech.data.prd/Database/DEFAULT/", "***REMOVED***", "***REMOVED***");
