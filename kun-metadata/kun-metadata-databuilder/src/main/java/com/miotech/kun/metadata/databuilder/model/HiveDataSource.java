...
public class HiveDataSource extends DataSource {
    ...
    public static Builder clone(HiveDataSource hiveDataSource) {
        return newBuilder().withId(hiveDataSource.getId())
                .withMetastoreUrl(hiveDataSource.getMetastoreUrl())
                .withMetastoreUsername(hiveDataSource.getMetastoreUsername())
                .withMetastorePassword(hiveDataSource.getMetastorePassword())
                .withDatastoreUrl(hiveDataSource.getDatastoreUrl())
                .withDatastoreUsername(hiveDataSource.getDatastoreUsername())
                .withDatastorePassword(hiveDataSource.getDatastorePassword());
    }
