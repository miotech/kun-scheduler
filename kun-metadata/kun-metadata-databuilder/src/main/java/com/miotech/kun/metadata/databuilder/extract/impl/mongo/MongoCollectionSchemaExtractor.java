...
public class MongoCollectionSchemaExtractor extends SchemaExtractorTemplate {
    ...
    public MongoCollectionSchemaExtractor(MongoDataSource mongoDataSource, String dbName, String collectionName) {
