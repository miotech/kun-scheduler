...
//        all content
        ...
        List<SearchedInfo> searchedInfoList1 = universalSearchDao.search(searchFilterOptionList1, request1.getResourceTypeNames(), 10);
...
//        one content
        ...
        List<SearchedInfo> searchedInfoList2 = universalSearchDao.search(searchFilterOptionList2, request2.getResourceTypeNames(), 10);
...
//    a part content
        ...
        List<SearchedInfo> searchedInfoList3 = universalSearchDao.search(searchFilterOptionList3, request2.getResourceTypeNames(), 10);
    ...
    void test_save_glossary() {
        ...
        List<SearchedInfo> searchedInfoList = universalSearchDao.search(request.getSearchFilterOptions(), request.getResourceTypeNames(), 10);
    ...
    void test_update() {
        ...
        List<SearchedInfo> afterSearchedInfoList = universalSearchDao.search(request.getSearchFilterOptions(), request.getResourceTypeNames(), 10);
    ...
    void test_remove() {
        ...
        List<SearchedInfo> searchedInfoListRemove = universalSearchDao.search(request.getSearchFilterOptions(), request.getResourceTypeNames(), 10);
    ...
    void test_search_filter_symbol() {
        ...
        List<SearchedInfo> searchedInfoList2 = universalSearchDao.search(request2.getSearchFilterOptions(),request2.getResourceTypeNames(),10);
