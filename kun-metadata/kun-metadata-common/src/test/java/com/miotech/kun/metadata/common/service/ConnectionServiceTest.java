...
class ConnectionServiceTest extends DatabaseTestBase {
    @Inject
    ...
    void test_add_datasource_connection_pg(Long datasourceId, DatasourceConnection mock_datasourceConnection) {
        List<ConnectionInfo> collect = mock_datasourceConnection.getDatasourceConnectionList().stream().map(mock_conn -> connectionService.addConnection(datasourceId, mock_conn)).collect(Collectors.toList());
        ...
        Optional<DatasourceConnection> fetch_datasourceConnectionOpt = connectionService.fetchDatasourceConnection(datasourceId);
    ...
    void test_update_datasource_connection_many_user_connection() {
        ...
        update_mock_datasourceConnection.getDatasourceConnectionList().stream().map(mock_conn -> connectionService.updateConnection(datasourceId, mock_conn)).collect(Collectors.toList());
        Optional<DatasourceConnection> update_datasourceConnectionOpt = connectionService.fetchDatasourceConnection(datasourceId);
    ...
    void test_update_datasource_connection_update_config() {
        ...
        mock_update_datasourceConnection.getDatasourceConnectionList().stream().map(mock_conn -> connectionService.updateConnection(datasourceId, mock_conn)).collect(Collectors.toList());
        Optional<DatasourceConnection> update_datasourceConnectionOpt = connectionService.fetchDatasourceConnection(datasourceId);
        assertThat(update_datasourceConnectionOpt.isPresent(), is(true));
        DatasourceConnection update_datasourceConnection = update_datasourceConnectionOpt.get();
    ...
    void test_add_connection() {
        ...
        ConnectionInfo connectionInfo1 = connectionService.addConnection(datasourceId, user_connectionInfo1);
        Optional<ConnectionInfo> connection = connectionService.findConnection(connectionInfo1.getId());
    ...
    void test_find_connection() {
        ...
        Optional<ConnectionInfo> connection1 = connectionService.findConnection(0L);
    ...
    void test_fetch_datasource_connection(Long datasourceId, DatasourceConnection mock_datasourceConnection) {
        ...
        Optional<DatasourceConnection> datasourceConnection = connectionService.fetchDatasourceConnection(System.currentTimeMillis());
    ...
    void test_fetch_datasource_connection_list(Long datasourceId, DatasourceConnection mock_datasourceConnection) {
        ...
        assertThat(fetch_datasourceConnectionOpt.isPresent(), is(true));
        DatasourceConnection fetch_datasourceConnection = fetch_datasourceConnectionOpt.get();
        List<ConnectionInfo> user_connectionInfos = connectionService.fetchDatasourceConnectionList(datasourceId, ConnScope.USER_CONN);
        ...
        List<ConnectionInfo> data_connectionInfos = connectionService.fetchDatasourceConnectionList(datasourceId, ConnScope.DATA_CONN);
        ...
        List<ConnectionInfo> metadata_connectionInfos = connectionService.fetchDatasourceConnectionList(datasourceId, ConnScope.METADATA_CONN);
        ...
        List<ConnectionInfo> storage_connectionInfos = connectionService.fetchDatasourceConnectionList(datasourceId, ConnScope.STORAGE_CONN);
    ...
    void test_fetch_connScope_connection() {
        ...
        ConnectionConfigInfo pgConnectionConfigInfo = new PostgresConnectionConfigInfo(ConnectionType.POSTGRESQL, "127.0.0.1", 5432, "test1", "test_pw");
        ConnectionInfo user_connectionInfo1 = MockConnectionFactory.mockConnectionInfo(null, "user conn", datasourceId, ConnScope.USER_CONN, pgConnectionConfigInfo, "connection");
        ConnectionInfo user_connectionInfo = connectionService.addConnection(datasourceId, user_connectionInfo1);
        List<ConnectionInfo> connectionInfos = connectionService.fetchConnScopeConnection(ConnScope.USER_CONN);
        assertThat(CollectionUtils.isNotEmpty(connectionInfos), is(true));
        assertThat(connectionInfos.get(0), is(user_connectionInfo));
        List<ConnectionInfo> data_connectionInfos = connectionService.fetchConnScopeConnection(ConnScope.DATA_CONN);
    ...
    void test_remove_connection() {
        ...
        assertThat(connection.isPresent(), is(true));
        assertThat(connection, is(Optional.of(connectionInfo1)));
        ConnectionInfo remove_connectionInfo = connectionService.deleteConnection(connection.get().getId());
        assertThat(remove_connectionInfo, Matchers.not(connection));
        assertThat(remove_connectionInfo.getDeleted(), is(true));
        Optional<ConnectionInfo> remove_connection = connectionService.findConnection(connection.get().getId());
    ...
    void test_remove_connection_by_datasource(Long datasourceId, DatasourceConnection mock_datasourceConnection) {
        ...
        assertThat(first_insert.getMetadataConnection().getId(), is(Matchers.notNullValue()));
        assertThat(first_insert.getStorageConnection().getId(), is(Matchers.notNullValue()));
        connectionService.fetchDatasourceConnection(datasourceId);
        connectionService.deleteConnectionByDatasource(datasourceId);
        Optional<DatasourceConnection> datasourceConnectionOpt = connectionService.fetchDatasourceConnection(datasourceId);
