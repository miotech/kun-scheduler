 ...
 **/
@JsonDeserialize(builder = ConnectionBasicInfoVo.Builder.class)
public class ConnectionBasicInfoVo {
    ...
    public ConnectionBasicInfoVo(Long id, Long datasourceId, String name, ConnScope connScope, ConnectionConfigInfo connectionConfigInfo,
    ...
    public boolean equals(Object o) {
        ...
        ConnectionBasicInfoVo that = (ConnectionBasicInfoVo) o;
    ...
    public static final class Builder {
        ...
        public ConnectionBasicInfoVo build() {
            return new ConnectionBasicInfoVo(id, datasourceId, name, connScope, connectionConfigInfo, description, deleted, updateUser, updateTime, createUser, createTime);
        }
    }

    @Override
    public String toString() {
        return "ConnectionBasicInfoVo{" +
                "id=" + id +
