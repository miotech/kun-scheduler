...
public class S3ConnectionConfigInfo extends ConnectionConfigInfo {
    ...
    @JsonCreator
    public S3ConnectionConfigInfo(@JsonProperty("connectionType") ConnectionType connectionType,
    ...
    public boolean equals(Object o) {
        ...
        S3ConnectionConfigInfo that = (S3ConnectionConfigInfo) o;
